...
const { getCourses } = require('../controllers/courseController'); // Import the getCourses function
...
describe('AddTask Function Test', () => {
  ...
  it('should create a new task successfully', async () => {
    ...
    const req = {
      ...
      body: { courseID: "New Task", coursename: "Task description", date: "2025-12-31" }
    };
...
describe('Update Function Test', () => {
  ...
  it('should update task successfully', async () => {
    ...
    // Assertions
    expect(existingTask.courseID).to.equal("New Task");
...
describe('GetTask Function Test', () => {
  ...
  it('should return tasks for the given user', async () => {
    ...
    // Mock task data
    const tasks = [
      { _id: new mongoose.Types.ObjectId(), courseID: "Task 1", userId },
      { _id: new mongoose.Types.ObjectId(), courseID: "Task 2", userId }
    ];
